...
export default class DetailsTransition {
  constructor(details) {
    ...
    DetailsTransition.customEvents.forEach((eventName) => {
  ...
  static enhance(details) {
    const instance = new DetailsTransition(details);
    instance.enable();
    return instance;
  }
  ...
  static enhanceAll(selector = 'details', bindToDetailsMarker = '.details-marker') {
    document.querySelectorAll(selector).forEach((el) => {
      const d = DetailsTransition.enhance(el);
